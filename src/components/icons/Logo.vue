...
const props = defineProps<{
	customLogo?: boolean;
	logoRef?: (el: HTMLDivElement) => void;
}>();
	...
	<div :ref="logoRef ?? (() => {})" v-bind="$attrs">
		<template v-if="!customLogo">
			...
			>
				...
				>
					<path
						d="M447.5 223.75C474.076 237.038 474.076 274.962 447.5 288.25L52.1812 485.909C28.2073 497.896 0 480.463 0 453.66V58.3404C0 31.5368 28.2073 14.1037 52.1812 26.0906L447.5 223.75Z"
						fill="#D9D9D9"
					/>
				</mask>
			...
			>
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
					d="M40.3108 0.495497L427.544 57.0333C449.747 60.2749 469.613 81.2467 472.037 103.878L511.76 474.734C514.15 497.064 498.447 513.687 476.566 511.863L95.0943 480.101C70.654 478.066 48.5091 457.12 45.7704 433.305L0.282897 37.6656C-2.49424 13.5121 15.4921 -3.12807 40.3108 0.495497Z"
					:fill="color"
				/>
				<path
					opacity="0.15"
