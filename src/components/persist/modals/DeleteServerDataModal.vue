...
const canDelete = computed(
	() => !connectionState.connectedCacheKeys.includes(modalProps.value.id),
);
...
<template>
	<div class="modal">
		...
		<div class="modal__content" v-if="!canDelete">
			{{ t("CANNOT_DELETE_CURRENT_SERVER_DATA") }}
		</div>
		...
		<div class="modal__actions">
			<div class="modal__buttons">
				<alt-button color="green" @click="confirm" v-if="canDelete">{{
					t("CONFIRM")
				}}</alt-button>
