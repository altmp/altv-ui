...
<template>
    <div class="modals">
        <div id="close-modal" v-if="modal.closeable" @click="modal.close(); playClickSound()" @mouseenter="playHoverSound">
        ...
        <delete-server-data-modal v-if="modal.type === ModalType.DeleteServerData" />
