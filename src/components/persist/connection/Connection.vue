...
<template>
    <div class="connection">
        ...
        <div class="connection__actions">
            ...
            <alt-button color="red" v-if="connectionState.showReconnect && (settings.data.debug || version.branch === 'internal' || version.branch === 'dev')" @click="reconnect">{{t('RECONNECT')}}</alt-button>
        </div>
    </div>
</template>
