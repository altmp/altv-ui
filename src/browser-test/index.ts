...
function getSetting<T extends keyof Settings>(key: T): Settings[T] {
	return (
		JSON.parse(localStorage.getItem("settings") ?? "{}")[key] ??
		defaultSettings[key]
	);
}
...
const history = [
	...
	{
		name: "Test server 4",
		id: "75364d28be416bb061f5d768a1c3cd80",
		url: "localhost:7788",
	},
