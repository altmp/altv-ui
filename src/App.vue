...
provide(PixelScaleContextKey, createPixelScaleContext());
...
onMounted(() => {
	if (version.orange) {
		...
		if (dvd) {
			...
			const { width: dvdWidth, height: dvdHeight } =
	...
	<router-view :dir="locale.dir" v-slot="{ Component }">
		<transition name="fade" :duration="200">
			<div
				id="page"
				dir="ltr"
				v-if="ui.ready && (ui.opened || !connection.connected)"
			>
				<side-navigation />
