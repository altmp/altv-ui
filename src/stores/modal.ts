...
export const useModalStore = useInitializableStore(
	defineStore("modal", {
		state: (): IModalState => {
			return {
				type: ModalType.None,
...
export const getModalProps = <T extends ModalType>(
	store: ReturnType<typeof useModalStore>,
) => computed(() => store.props as IModalProps[T]);
