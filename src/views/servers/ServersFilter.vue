    ...
    <div class="filter">
        ...
        <div class="filter__group">
            ...
            <div class="filter__input-grid">
                <alt-input v-model="filters.minPlayers" placeholder="0" :pattern="/\D/g"></alt-input>
                <alt-input v-model="filters.maxPlayers" :placeholder="'4\xa0096'" :pattern="/\D/g"></alt-input>
                <h4>{{ t('MIN') }}</h4>
                <h4>{{ t('MAX') }}</h4>
            </div>
        </div>
        ...
        <div class="filter__group">
            ...
            <div class="filter__input-grid">
                <alt-input v-model="filters.minSlots" placeholder="0" :pattern="/\D/g"></alt-input>
                <alt-input v-model="filters.maxSlots" :placeholder="'4\xa0096'" :pattern="/\D/g"></alt-input>
                <h4>{{ t('MIN') }}</h4>
                <h4>{{ t('MAX') }}</h4>
            </div>
        </div>
...
<!--        </div>-->
        ...
        <div class="filter__group">
            ...
            <div class="filter__group-checkboxes">
                <alt-checkbox v-model="filters.hideFull" :label="t('HIDE_FULL')"></alt-checkbox>
                <alt-checkbox v-model="filters.hideEmpty" :label="t('HIDE_EMPTY')"></alt-checkbox>
                <alt-checkbox v-model="filters.hideLocked" :label="t('HIDE_LOCKED')"></alt-checkbox>
            </div>
        </div>
    </div>
</template>
